...
#define sFLASH_CMD_BE             0xC7  /*!< Bulk Erase instruction 块*/

#define sFLASH_WIP_FLAG           0x01  /*!< Write In Progress (WIP) flag */

#define sFLASH_DUMMY_BYTE         0x00  //无效字符
...
//用来保存WIFI参数的代码
#define  FLASH_WriteAddress     0x700000       //用来保存wifi参数
#define  FLASH_ReadAddress      FLASH_WriteAddress    //读
#define  FLASH_SectorToErase    FLASH_WriteAddress    //擦除
